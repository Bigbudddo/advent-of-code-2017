...
namespace AdventOfCode2017.Puzzles {
    ...
    public sealed class Day4 : iPuzzle {
        ...
        private readonly string _input = @"kvvfl,kvvfl,olud,wjqsqa,olud,frc
        ...
        public Day4() {
            ...
            foreach(string row in _input.Split(new[] { Environment.NewLine }, StringSplitOptions.None)) {
                _rows.Add(row.Split(',').Select(x => x.Trim()).ToArray());
            }
        }
        ...
        public void Part2() {
            ...
            foreach (var row in _rows) {
                ...
                for (var i = 0; i < row.Length; i++) {
                    ...
                    foreach (var t in tmp) {
                        if (this.IsAnagram(t, checkValue)) {
                            isValid = false;
                            break;
                        }
                    }
